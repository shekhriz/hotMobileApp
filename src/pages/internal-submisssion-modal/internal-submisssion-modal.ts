...
/**
 * Generated class for the InternalSubmisssionModalPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-internal-submisssion-modal',
  templateUrl: 'internal-submisssion-modal.html',
})
export class InternalSubmisssionModalPage {
  positionId:string;
  token:string;
  loginUser:any = {};
  internalData:any;
